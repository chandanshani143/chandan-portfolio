...
const ref = useRef<HTMLDivElement>(null);
  ...
  const mask = useMotionTemplate`radial-gradient(100px 
  100px at ${xDistance}px ${yDistance}px, #000, transparent)`;
  ...
  const handleMouseMove = (e: MouseEvent) => {
    ...
    xDistance.set(e.y - clientRect.y);
  };
  ...
  useEffect(() => {
    ...
    }                                                                 /*  good practice in react to remove the eventlistener after the element is not present in DOM*/
  }, [])
  return (
    <Reveal duration={1.5}>
